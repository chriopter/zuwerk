...
module AccountRouteTestHelpers
  ACCOUNT_ROUTES = %i[
    ...
    project_briefing_comment_reactions_path project_library_pages_path project_library_page_path reorder_project_library_page_path project_library_page_file_path
    project_task_lists_path reorder_project_task_list_path
